var appcrit = (function () {
  ...
  var appcrit = function () {
  	function appcrit(c, vb, sections) {
  	...
  	createClass(appcrit, [{
  		...
  		value: function loadData(data) {
  			...
  			nav.find("a").click(function (e) {
  				...
  				var prose = $(self.dom).find("tei-div[type=textpart] tei-ab,tei-div[type=textpart] tei-p").length > 0;
  				if (!prose) {
  			...
  			var chunks = $(this.dom).find(this.sections);
  			if (chunks.length > 0) {
